    ...
    <div className="h-[calc(100vh - 16px)] fixed bottom-[16px] z-50 flex w-[100dvw] items-end justify-center overflow-hidden">
      <div className="relative flex flex-col [perspective:1000px]">
        <div className="relative grid justify-items-start [perspective:1000px]">
          <div
            className={`relative col-[1] row-[1] w-full origin-bottom bg-black text-center text-[#ffe000] uppercase transition-all duration-500 ${NavOpen ? '' : 'invisible scale-y-0'}`}
          >
            <div>
